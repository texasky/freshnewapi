...
define(["exports", "./model.js", "./view.js", "./data.js"], function (exports, _model, _view, _data) {
  "use strict";
...
define(["./data.js", "./model.js", "./view.js"], function (_data, _model, _view) {
  "use strict";
...
define(["exports"], function (exports) {
  ...
  var bbc = exports.bbc = document.getElementById('bbc');
  var cnn = exports.cnn = document.getElementById('cnn');
  var lenta = exports.lenta = document.getElementById('lenta');
  var reuters = exports.reuters = document.getElementById('reuters');
  var natgeo = exports.natgeo = document.getElementById('natgeo');
  var channelsUrlArr = exports.channelsUrlArr = new Map([[bbc, 'bbc-news'], [cnn, 'cnn'], [lenta, 'lenta'], [reuters, 'reuters'], [natgeo, 'national-geographic']]);
});
"use strict";
...
define(["exports"], function (exports) {
  ...
  var getFeed = exports.getFeed = function () {
    var _ref = _asyncToGenerator(
    /*#__PURE__*/
    regeneratorRuntime.mark(function _callee(url) {
      var response, jsonResponse, articlesArr;
...
define(["exports", "./data.js"], function (exports, _data) {
  "use strict";

  Object.defineProperty(exports, "__esModule", {
    value: true
  });
  exports.renderNews = undefined;

  var renderNews = exports.renderNews = function renderNews(articles) {
    articles.map(function (article) {
      var articleCell = "<div class=\"articlecell\" style=\"background: url('".concat(article.urlToImage, "') no-repeat center; background-color: rgba(0,0,0,.5); background-blend-mode: darken;\">\n        <div class=\"titleblock\"><h2 class=\"title\">'").concat(article.title, "'</h2></div>\n        <div class=\"descriptionblock\"><p>'").concat(article.description, "'</p></div>\n       </div>");
      _data.main.innerHTML += articleCell;
    });
